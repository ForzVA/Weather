...
function TodayWeather({ longitude, latitude }) {
    ...
    useEffect(() => {
        if (setTodayWeather && latitude && longitude) {
            ...
            <div className={s.todayWeather_wrapper}>
                ...
                <div className={s.todayWeather_bottom}>
                    <div className={s.todayWeather_wind}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" className="bi bi-wind" viewBox="0 -1 16 16">
                    ...
                    <div className={s.todayWeather_humidity}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" className="bi bi-droplet" viewBox="0 0 16 16">
                    ...
                    <div className={s.todayWeather_pressure}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="25" fill="currentColor" className="bi bi-cloud-download" viewBox="0 0 16 16">
        ...
        return (
            <div className={s.todayWeather_wrapper}>
                ...
                <div className={s.todayWeather_middle}>
                    ...
                    <div className={s.todayWeather_svg}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="150px" fill="currentColor" className="bi bi-cloud-drizzle" viewBox="0 0 16 16">
